...
function showExperience(experiences) {
    ...
    experiences.forEach((experience, i) => {
        ...
        <div class="container `+((i % 2 == 0) ?  "right" : "left" )+`">
            <div class="content">
                <img  style="border-radius: 10px; width: 150px; height: 110px; float: right; padding: 1.5px; padding-left: 0px;" src="../assets/images/experience/${experience.image}" alt="">
                <div class="tag">
...
(function(){
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/66b1cdfd32dca6db2cba724b/1i4j8pa31';
    s1.charset='UTF-8';
